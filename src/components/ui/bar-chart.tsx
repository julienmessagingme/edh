...
export interface BarXAxisProps {
   ...
   *  Chaque libellé est contraint à `labelWidth` (défaut = largeur de la
   *  barre) et centré sous sa colonne, clampé à 3 lignes. Utile quand il y a
   *  beaucoup de colonnes à libellés longs (funnels de campagne). */
  wrap?: boolean;
