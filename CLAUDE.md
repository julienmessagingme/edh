...
| 22 — Pie chart en plus du funnel (migration 011 `type IN ('funnel','pie')`, radio à la création dans Mes tableaux + Campagnes, recharts PieChart + PieTable base 100, export Excel adapté) | ✅ |
