...
| 32 — Coût Meta : couverture indicatifs `meta-pricing.ts` 50 → 114 (toute l'Afrique subsaharienne en tier « Rest of Africa » ≈ 0,021 € — diagnostic : 38 % des numéros d'un gros event EFAP tombaient en « Autre », dont 89 % Madagascar +261 absent de la table ; + Europe Est/Caucase + Asie ; **réalignement des anciens tarifs africains périmés** du modèle conversation vers le per-message 2025 ; fallback « Autre » 0,05 → 0,055 €). « Autre » 38 % → 0,5 % (reste = numéros malformés). Valeurs = estimations rate card 2025/2026, à caler sur la facture WABA réelle | ✅ |
